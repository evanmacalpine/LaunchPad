			...
			<Container className="flex flex-col md:flex-row justify-between items-center w-full px-8">
				<div className="flex flex-col">
					<motion.h2
						...
						viewport={{ once: true, amount: 0.5 }} // Optional fine-tuning
						transition={{ duration: 0.6, ease: "easeOut" }}
						className="text-white text-sm text-center md:text-left md:text-3xl font-bold mx-auto md:mx-0 max-w-xl "
					>
						{heading}
					</motion.h2>
